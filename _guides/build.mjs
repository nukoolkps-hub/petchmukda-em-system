...
function header(title, subtitle, pageLabel, accentIcon) {
  ...
  // gem + brand
  s += gem(60, 52, 56);
  s += text(150, 78, "ห้างเพชรทองมุกดา", {
    size: 30,
    weight: 600,
    fill: C.goldLt,
  });
  ...
  // page chip
  if (pageLabel) {
    const pl = chip(W - 60 - (textWidth(pageLabel, 22) + 32), 50, pageLabel, {
  ...
  if (subtitle)
    s += text(tx, 218, subtitle, { size: 24, weight: 400, fill: "#EAD9C2" });
  return { svg: s, h: H };
}
...
function footer(y) {
  ...
  s += text(86, y + 28 + 36, "petchmukda-bot.web.app", {
    size: 24,
    weight: 600,
    fill: C.goldLt,
  });
  s += text(W - 60, y + 28 + 36, "เข้าผ่านมือถือได้เลย", {
    size: 22,
    weight: 400,
    fill: C.faint,
    anchor: "end",
...
function step(x, y, n, title, desc, o = {}) {
  ...
  let h = 48;
  if (desc) {
    const p = paragraph(x + 86, y + 70, desc, {
      size: 25,
      fill: C.sub,
      maxW: w - 90,
      lh: 1.4,
...
function callout(x, y, w, txt, o = {}) {
  ...
  const p = paragraph(x + 70, y + 40, txt, {
    size: 24,
    fill: tcol,
    maxW: w - 96,
    lh: 1.4,
...
function lineChatScreen(ix, iy, iw, ih) {
  ...
  p += text(ix + 54, iy + 35, "99+", {
    size: 15,
    weight: 700,
    fill: "#FFF",
    anchor: "middle",
  });
  p += text(ix + 90, iy + 36, "PETCHMUKDA BOT", {
    size: 19,
    weight: 700,
    fill: "#222",
  });
  p += text(ix + iw - 18, iy + 36, "☰", {
    size: 22,
    fill: "#555",
    anchor: "end",
  });
  ...
  p += text(bx + 18, by + 30, "คำขอเบิกเงินล่วงหน้า", {
    size: 17,
    weight: 700,
    fill: "#FFF",
  });
  ...
  p += text(bx + 28, by + 102, "฿1,000", {
    size: 26,
    weight: 700,
    fill: C.maroon,
  });
  p += text(bx + 18, by + 140, "พนักงาน   ฉรินทรญ์ นาคราช", {
    size: 14,
    fill: "#555",
  });
  ...
  p += text(ix + iw / 2, fy + 44, "FOR STAFF", {
    size: 30,
    weight: 700,
    fill: C.maroon,
    anchor: "middle",
  ...
  p += text(ix + iw / 2, rmY + rmH - 16, "ห้างเพชรทองมุกดา", {
    size: 14,
    fill: C.goldLt,
    anchor: "middle",
  });
  ...
  p += rrect(fx - 6, fy - 6, fw + 12, 76, 18, "none", {
    stroke: C.goldLt,
    sw: 4,
  });
...
function buildCover() {
  ...
  const h = header(
    ...
    "เริ่มต้นใช้งานง่ายๆ ใน 4 เมนูหลัก",
    null,
    null,
  );
  s += h.svg;
  ...
  s += text(60, y + 10, "ระบบนี้ทำอะไรได้บ้าง?", {
    size: 30,
    weight: 700,
    fill: C.maroon,
  });
  ...
  const tiles = [
    ...
    [
      "fileText",
      "ยื่นคำขอลา",
      "ลากิจ / ลาป่วย เลือกวันแล้วกดยื่นได้เลย",
      C.blue,
      C.blueBg,
    ],
  ...
  tiles.forEach((t, i) => {
    ...
    s += text(tx + 110, ty + 64, t[1], {
      size: 30,
      weight: 700,
      fill: C.maroon,
    });
    const p = paragraph(tx + 110, ty + 104, t[2], {
      size: 23,
      fill: C.sub,
      maxW: tw - 130,
      lh: 1.35,
    ...
    s += p.svg;
    s += text(tx + 32, ty + th - 30, "เมนูด้านล่างจอ", {
      size: 19,
      weight: 500,
      fill: t[3],
    });
  ...
  const co = callout(
    ...
    y,
    W - 120,
    'เข้าระบบ: แตะเมนู "FOR STAFF" ใน LINE Bot ของร้าน (หรือเปิดลิงก์เว็บ) แล้วกดปุ่มเขียว "Login ด้วย LINE"',
    { ic: "lineChat", accent: C.lineGreen, bg: "#E8F8EE", tcol: "#1B5E36" },
  );
  s += co.svg;
  y += co.h + 30;

  // mini nav demo
  s += text(60, y + 10, "แถบเมนูหลัก (อยู่ด้านล่างของจอเสมอ)", {
    size: 24,
    weight: 600,
    fill: C.maroon,
  });
...
function buildLogin() {
  ...
  const h = header(
    "วิธีเข้าสู่ระบบ",
    "เข้าได้ 2 ทาง — แนะนำผ่าน LINE Bot",
    "1 / 5",
    "login",
  );
  s += h.svg;
  ...
  // --- two method cards ---
  s += text(60, y + 10, "เลือกวิธีเข้าระบบ", {
    size: 30,
    weight: 700,
    fill: C.maroon,
  });
  ...
  const r1 = chip(60 + 100, y + 34, "แนะนำ", {
    bg: C.greenBg,
    fill: "#1B5E36",
    size: 18,
    h: 32,
  ...
  s += r1.svg;
  s += text(60 + 100, y + 96, "ผ่าน LINE Bot", {
    size: 28,
    weight: 700,
    fill: C.maroon,
  });
  s += paragraph(60 + 32, y + 126, 'แตะแถบเมนู "FOR STAFF" ในแชทบอท', {
    size: 22,
    fill: C.sub,
    maxW: mw - 60,
  }).svg;
  ...
  s += text(m2x + 100, y + 60, "เปิดลิงก์เว็บ", {
    size: 28,
    weight: 700,
    fill: C.maroon,
  });
  s += paragraph(
    m2x + 32,
    y + 100,
    "พิมพ์ petchmukda-bot.web.app ในเบราว์เซอร์มือถือ",
    { size: 22, fill: C.sub, maxW: mw - 60 },
  ).svg;
  y += mh + 40;

  // --- highlighted method: LINE Bot, phone mockup + steps ---
  s += rrect(60, y, 8, 36, 4, C.lineGreen);
  s += text(86, y + 30, "วิธีที่ 1 — เข้าผ่าน LINE Bot", {
    size: 28,
    weight: 700,
    fill: C.maroon,
  });
  ...
  const steps = [
    ...
    [
      'แตะแถบสีแดง "FOR STAFF"',
      'อยู่ด้านล่างสุดของจอ · ถ้าไม่เห็น ให้แตะคำว่า "เมนู ▾" เพื่อกางเมนูออกมาก่อน',
    ],
  ...
  steps.forEach((st, i) => {
    ...
    s += r.svg;
    if (i < steps.length - 1)
      s += `<line x1="94" y1="${sy + 70}" x2="94" y2="${sy + r.h + 30}" stroke="${C.goldPale}" stroke-width="3"/>`;
    sy += r.h + 24;
  });
  ...
  s += text(60 + Math.min(colW, 320) / 2 + 18, lb + 39, "Login ด้วย LINE", {
    size: 23,
    weight: 700,
    fill: "#FFFFFF",
    anchor: "middle",
  ...
  const co = callout(
    ...
    yBottom,
    W - 120,
    'ใช้บัญชี LINE ที่ลงทะเบียนกับร้านเท่านั้น — ถ้าขึ้น "ยังไม่พบข้อมูลพนักงาน" ให้แจ้งแอดมินเพื่อเชื่อมบัญชีให้',
    { ic: "info", accent: C.maroon, bg: C.redBg, tcol: C.maroon },
  );
  s += co.svg;
  yBottom += co.h + 24;
...
function buildLeave() {
  ...
  const h = header(
    "หน้าแรก + ยื่นใบลา",
    "ดูโควต้า แล้วยื่นลาได้ในไม่กี่ขั้นตอน",
    "2 / 5",
    "calendar",
  );
  s += h.svg;
  ...
  s += phone(px, py, pw, ph, (ix, iy, iw, ih) => {
    ...
    p += text(ix + 40, yy + 36, "โควต้าการลาเดือนนี้", {
      size: 19,
      weight: 600,
      fill: C.maroon,
    });
    p += text(ix + 40, yy + 70, "ใช้ไปแล้ว", { size: 16, fill: C.sub });
    p += text(ix + iw - 44, yy + 74, "0 / 2 วัน", {
      size: 30,
      weight: 700,
      fill: C.green,
      anchor: "end",
    ...
    p += text(ix + 20 + bw / 2 + 18, yy + 44, "ลากิจ", {
      size: 22,
      weight: 700,
      fill: C.blue,
      anchor: "middle",
    ...
    p += rrect(ix + 36 + bw, yy, bw, 70, 14, "#FFFFFF", {
      stroke: C.line,
      sw: 2,
    });
    p += text(ix + 36 + bw + bw / 2, yy + 44, "ลาป่วย", {
      size: 22,
      weight: 600,
      fill: C.sub,
      anchor: "middle",
    ...
    ["วันที่เริ่มลา", "วันที่สิ้นสุด"].forEach((lb) => {
      ...
      p += rrect(ix + 20, yy + 14, iw - 40, 50, 12, "#FFFFFF", {
        stroke: C.line,
        sw: 2,
      });
    ...
    p += text(ix + 40, yy + 30, "รวมจำนวนวันทำการ", {
      size: 18,
      weight: 600,
      fill: C.maroon,
    });
    p += text(ix + 40, yy + 54, "(ไม่รวมวันที่ร้านปิด)", { size: 14, fill: C.sub });
    p += text(ix + iw - 44, yy + 48, "1 วัน", {
      size: 28,
      weight: 700,
      fill: C.maroon,
      anchor: "end",
    ...
    p += text(ix + iw / 2, yy + 39, "ยื่นคำขอลา", {
      size: 24,
      weight: 700,
      fill: "#FFFFFF",
      anchor: "middle",
  ...
  steps.forEach((st, i) => {
    ...
    s += r.svg;
    if (i < steps.length - 1)
      s += `<line x1="94" y1="${y + 70}" x2="94" y2="${y + r.h + 30}" stroke="${C.goldPale}" stroke-width="3"/>`;
    y += r.h + 24;
  });
  ...
  const c1 = callout(
    ...
    yB,
    W - 120,
    "โควต้า ลากิจ + ลาป่วย รวมกัน 2 วัน/เดือน · ลาเกินโควต้าจะมีผลต่อเงินเดือน · ลาวันที่ร้านปิดไม่นับและไม่หัก",
    { ic: "info", accent: C.gold },
  );
  s += c1.svg;
  yB += c1.h + 16;
  const c2 = callout(
    ...
    yB,
    W - 120,
    'ใบลาที่ยังไม่ถึงวัน สามารถกดลบเองได้ที่ "ประวัติการลาของคุณ"',
    { ic: "check", accent: C.green, bg: C.greenBg, tcol: "#1B5E36" },
  );
  s += c2.svg;
  yB += c2.h + 24;
...
function buildSalary() {
  let s = "";
  const h = header(
    "ดูเงินเดือน + พิมพ์สลิป",
    "เช็คยอด พิมพ์สลิป และหนังสือรับรอง",
    "3 / 5",
    "wallet",
  );
  s += h.svg;
  ...
  s += phone(px, py, pw, ph, (ix, iy, iw, ih) => {
    ...
    let yy = iy + 18;
    // month nav
    p += text(ix + 24, yy + 22, "สลิปเงินเดือน", {
      size: 18,
      weight: 600,
      fill: C.maroon,
    });
    p += text(ix + iw - 24, yy + 22, "‹  มิ.ย. 2569  ›", {
      size: 18,
      weight: 600,
      fill: C.sub,
      anchor: "end",
    ...
    p += text(ix + 44, yy + 96, "18,540 ฿", {
      size: 46,
      weight: 700,
      fill: "#FFFFFF",
    });
    p += text(ix + iw - 44, yy + 56, "+ รายรับ", {
      size: 15,
      fill: "#9FE3B5",
      anchor: "end",
    });
    p += text(ix + iw - 44, yy + 82, "− รายการหัก", {
      size: 15,
      fill: "#F2B7AE",
      anchor: "end",
    });
    ...
    p += text(ix + 20 + bw / 2 + 16, yy + 38, "พิมพ์สลิป", {
      size: 20,
      weight: 700,
      fill: "#FFF",
      anchor: "middle",
    });
    p += rrect(ix + 36 + bw, yy, bw, 60, 14, "#FFFFFF", {
      stroke: C.maroon,
      sw: 2.5,
    });
    p += icon("fileText", ix + 36 + bw + 18, yy + 16, 28, C.maroon, 2);
    p += text(ix + 36 + bw + bw / 2 + 14, yy + 38, "ใบรับรอง", {
      size: 20,
      weight: 700,
      fill: C.maroon,
      anchor: "middle",
    ...
    const rows = [
      ...
      ["โบนัสแห่งความขยัน", "+ 1,000"],
      ["ค่าคอมขาย", "+ 3,200"],
    ];
    rows.forEach(([a, b]) => {
      p += text(ix + 40, yy + 24, a, { size: 18, fill: C.ink });
      p += text(ix + iw - 44, yy + 24, b, {
        size: 18,
        weight: 600,
        fill: C.green,
        anchor: "end",
  ...
  const c1 = callout(
    ...
    yB,
    W - 120,
    'ถ้าขึ้น "รอ ADMIN ยืนยันยอด" แปลว่ายอดยังเป็นแค่ประมาณการ — ปุ่มพิมพ์สลิปจะใช้ได้หลังแอดมินยืนยันยอดแล้ว',
    { ic: "bell", accent: C.gold },
  );
  s += c1.svg;
  yB += c1.h + 16;
  const c2 = callout(
    ...
    yB,
    W - 120,
    'ต้องการเงินก่อนสิ้นเดือน? กดปุ่ม "เบิกเงิน" เพื่อขอเบิกล่วงหน้า และดู "ประวัติเบิกเงิน" ได้',
    { ic: "coins", accent: C.green, bg: C.greenBg, tcol: "#1B5E36" },
  );
  s += c2.svg;
  yB += c2.h + 24;
...
function buildKnowledge() {
  let s = "";
  const h = header(
    "ความรู้ + เครื่องคิดเลข",
    "ราคาทองวันนี้ และคำนวณราคาได้ทันที",
    "4 / 5",
    "brain",
  );
  s += h.svg;
  ...
  s += phone(px, py, pw, ph, (ix, iy, iw, ih) => {
    ...
    p += text(ix + 40, yy + 34, "ราคาทองคำแท่ง 96.5%", {
      size: 18,
      fill: C.goldLt,
    });
    p += text(ix + 40, yy + 74, "52,150", {
      size: 38,
      weight: 700,
      fill: "#FFFFFF",
    });
    p += text(ix + iw - 44, yy + 74, "฿/บาท", {
      size: 18,
      fill: C.goldLt,
      anchor: "end",
    });
    yy += 112;
    // search
    p += rrect(ix + 20, yy, iw - 40, 52, 26, "#FFFFFF", {
      stroke: C.line,
      sw: 2,
    });
    ...
    const accs = [
      "มาตรฐานน้ำหนัก (สคบ.)",
      "ราคาขาย ทอง 96.5%",
      "ค่าเปลี่ยน นน. เท่ากัน",
    ];
    accs.forEach((a, i) => {
      p += rrect(ix + 20, yy, iw - 40, 50, 12, "#FFFFFF", {
        stroke: C.line,
        sw: 1.5,
      });
      p += icon(
      ...
      if (i === 1) {
        ...
        p += text(ix + 40, yy + 30, "เครื่องคิดเลขราคาขาย", {
          size: 17,
          weight: 700,
          fill: C.maroon,
        });
        // input rows
        p += text(ix + 40, yy + 62, "น้ำหนักสินค้า (กรัม)", {
          size: 15,
          fill: C.sub,
        });
        p += rrect(ix + 40, yy + 72, iw - 80, 40, 10, "#FFFFFF", {
          stroke: C.line,
          sw: 1.5,
        });
        ...
        p += text(ix + 56, yy + 154, "ราคาขายต่อชิ้น", {
          size: 15,
          fill: C.goldLt,
        });
        p += text(ix + iw - 56, yy + 154, "12,650 ฿", {
          size: 22,
          weight: 700,
          fill: "#FFFFFF",
          anchor: "end",
  ...
  const c1 = callout(
    ...
    yB,
    W - 120,
    "มีหัวข้อให้ดูกว่า 15 เรื่อง เช่น มาตรฐานน้ำหนัก, ราคาขายทอง 96.5%/99.99%/นาก/เงิน, ค่าเปลี่ยน, แปลงน้ำหนักเป็นกรัม",
    { ic: "info", accent: C.gold },
  );
  s += c1.svg;
  yB += c1.h + 24;

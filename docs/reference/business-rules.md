...
· `coveragePay` ถูก preserve ค่าเดิมเมื่อมี snapshot อยู่แล้ว (ไม่ re-stamp
จากสถานะ leaves ปัจจุบัน · ดู `preserveCoverage` ใน updateSalary) ส่วน
...
|---|---|
| เรท/ตำแหน่ง/baseSalary/ขึ้นเงินเดือน/ประกันสังคม/poolExclusion/ปิดสิทธิ์/รายการประจำ (`updateEmployee`) | `diffSalaryFields` |
...
| เพิ่ม/แก้/ลบ เงินกู้ผ่อนคืน | "เพิ่ม/แก้/ลบเงินกู้ผ่อนคืน" |
| แก้รายการหักกองกลาง (`setPoolAdjustment`) | "แก้รายการหักกองกลาง" |
| แก้ปฏิทินเปิด-ปิดร้าน (`updateStoreCalendar`) | "แก้ปฏิทินเปิด-ปิดร้าน" |

...
- **Metal tones (knowledge content + price cards):** material → สี · "tone" prop ใน `h3`/`table`/`calculator`/`live-example`
  ...
  - กฎ: เมื่อเพิ่ม example/calculator/table ใหม่ ต้อง tag tone ให้ตรงกับวัสดุ — อย่าทิ้ง default maroon ไว้กับ section เงิน/นาก

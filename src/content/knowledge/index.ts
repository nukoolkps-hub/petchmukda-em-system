    ...
    blocks: [
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง − 3-5%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
      {
    ...
    blocks: [
      ...
      { type: "h3", text: "วิธีการคำนวณราคารับซื้อทองรูปพรรณ" },
      {
        ...
        rows: [
          ...
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง − 5-7%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
    ...
    blocks: [
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง × 60%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
          [
            "มีการตรวจ %",
  ...
  /* ── 5d. รับซื้อเงิน ── */
  {
    ...
    blocks: [
      ...
      { type: "h3", tone: "silver-text", text: "วิธีการคำนวณราคารับซื้อเงิน" },
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["ตามน้ำหนักชั่ง", "(ราคารับซื้อเงินแท่ง 99.99% × 75%) × น้ำหนักสินค้า = ราคารับซื้อ"],
          [
            "มีการตรวจ %",

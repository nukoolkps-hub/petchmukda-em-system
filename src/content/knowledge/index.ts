  ...
  /* ── ส่วนลด ── */
  {
    ...
    blocks: [
      ...
      { type: "h3", text: "ส่วนลด (ทอง 90)" },
      {
        type: "list",
        items: [
          "ต่างหูแผง (ราคาขาย) — ปกติ ลด 10% HBD ลด 15%",
          "ต่างหู (ค่าแรงขาย) — ปกติ ลด 15% HBD ลด 25%",
          "พระแผง (ราคาขาย) — ปกติ ลด 10% HBD ลด 15%",
          "กรอบพระ (ค่าแรงขาย) — ปกติ ลด 15% HBD ลด 25%",
          "Italy 18k (ค่าแรงขาย/กรัม) — ปกติ ลด 15% HBD ลด 25%",
        ],
      },

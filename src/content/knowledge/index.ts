  ...
  /* ── 3b. ราคาขายทอง 96.5% ── */
  {
    ...
    blocks: [
      { type: "h3", text: "วิธีการคำนวณราคาขายทองรูปพรรณ 96.5%" },
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["0.6 กรัม", "(ราคาขายออกทองคำแท่ง × 0.0656 × 0.6) + ค่าแรง/ค่าบล็อก = ราคาขาย"],
          ["1 กรัม", "(ราคาขายออกทองคำแท่ง × 0.0656 × 1) + ค่าแรง/ค่าบล็อก = ราคาขาย"],
          ...
          ["2 บาท ขึ้นไป", "(ราคาขายออกทองคำแท่ง + ค่าแรง/ค่าบล็อกต่อบาท) × จำนวนบาท = ราคาขาย"],
          ["ตามน้ำหนักชั่ง", "(ราคาขายออกทองคำแท่ง × 0.0656 × น้ำหนักสินค้า) + ค่าแรง/ค่าบล็อก = ราคาขาย"],
        ],
      },
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "หากเปลี่ยน MD มากกว่า **ต้องเพิ่มเงิน** = ส่วนต่าง MD × 100 ฿ (น้ำหนัก ≥ 2 บาท คูณจำนวนบาทด้วย) · ดูตัวช่วยด้านล่าง",
        ],
      },

    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ["½ สลึง", "(ราคาทอง × 0.125) + ค่าแรง = ราคาขาย"],
          ["1 สลึง", "(ราคาทอง × 0.25) + ค่าแรง = ราคาขาย"],
          ["2 สลึง", "(ราคาทอง × 0.50) + ค่าแรง = ราคาขาย"],
          ["3 สลึง", "(ราคาทอง × 0.75) + ค่าแรง = ราคาขาย"],
          ["1 บาท", "ราคาทอง + ค่าแรง = ราคาขาย"],
          ["6 สลึง", "(ราคาทอง × 1.50) + ค่าแรง = ราคาขาย"],
          ["2 บาท ขึ้นไป", "(ราคาทอง + ค่าแรงต่อบาท) × จำนวนบาท = ราคาขาย"],
          ["ตามน้ำหนักชั่ง", "(ราคาทอง × 0.0656 × น้ำหนักสินค้า) + ค่าแรง = ราคาขาย"],
        ],
      },
    ...
    blocks: [
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["ตามน้ำหนักชั่ง", "(ราคาทอง − 5-7%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ"],
        ],
      },
      {
        type: "calculator",
    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ["½ สลึง", "(ราคาทอง − 5-7%) × 0.125 = ราคารับซื้อ"],
          ["1 สลึง", "(ราคาทอง − 5-7%) × 0.25 = ราคารับซื้อ"],
          ["2 สลึง", "(ราคาทอง − 5-7%) × 0.50 = ราคารับซื้อ"],
          ["3 สลึง", "(ราคาทอง − 5-7%) × 0.75 = ราคารับซื้อ"],
          ["1 บาท", "(ราคาทอง − 5-7%) = ราคารับซื้อ"],
          ["6 สลึง", "(ราคาทอง − 5-7%) × 1.5 = ราคารับซื้อ"],
          ["2 บาท ขึ้นไป", "(ราคาทอง − 5-7%) × จำนวนบาททอง = ราคารับซื้อ"],
          ["ตามน้ำหนักชั่ง", "(ราคาทอง − 5-7%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ"],
        ],
      },
    ...
    blocks: [
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["ตามน้ำหนักชั่ง", "(ราคาทอง × 60%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ"],
          [
            "มีการตรวจ %",
    ...
    blocks: [
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["ตามน้ำหนักชั่ง", "(ราคาทอง × 25%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ"],
          [
            "มีการตรวจ %",
            "(ราคาทอง × (%จริง − 10)) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
  ...
  /* ── 12. ภาษี VAT ── */
  {
    ...
    blocks: [
      { type: "h3", text: "วิธีคำนวณ VAT นอก" },
      {
        ...
        ordered: true,
        items: [
          "(ราคาทอง × 0.0656 × น้ำหนักสินค้า) + ค่าแรง (ตามตาราง) = ราคาขาย",

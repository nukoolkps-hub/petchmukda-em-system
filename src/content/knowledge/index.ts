...
export const KNOWLEDGE_SECTIONS: KnowledgeSection[] = [
  ...
  /* ── 6. ค่าบล็อก ── */
  {
    ...
    blocks: [
      ...
      {
        type: "table",
        columns: ["น้ำหนัก", "ค่าบล็อก (฿)", "น้ำหนัก", "ค่าส่ง (฿)"],
        rows: [
          ["0.05 กรัม – 1 บาท", "300 / 350 / 450", "0.05 กรัม – 10 บาท", "60"],
          ["2 บาท", "500 / 600 / 900", "1 กิโล", "200"],
          ["5 บาท", "1,000", "", ""],
          ["10 บาท", "1,000", "", ""],
          ["1 กิโล", "6,500", "", ""],
        ],
      ...
      { type: "h3", text: "เงินแท่ง" },
      {
        ...
        columns: ["น้ำหนัก", "ค่าบล็อก (฿)", "น้ำหนัก", "ค่าส่ง (฿)"],
        rows: [
          ["½ สลึง – 1 บาท", "350", "1 บาท – 10 บาท", "60"],
          ["5 บาท", "500", "20 บาท", "100"],
          ["10 บาท", "700", "1 กิโล", "200"],
          ["20 บาท", "1,000", "", ""],
          ["1 กิโล", "2,000", "", ""],
        ],
      },

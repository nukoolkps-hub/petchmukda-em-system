...
export const KNOWLEDGE_SECTIONS: KnowledgeSection[] = [
  /* ── 1. มาตรฐานน้ำหนัก ── */
  {
    ...
    Icon: IconWeight,
    blocks: [
      { type: "h3", text: "น้ำหนักทองคำแท่ง 96.5%" },
      {
        type: "table",
      ...
      { type: "h3", tone: "silver-text", text: "น้ำหนักเงินแท่ง 99.99%" },
      {
        type: "table",
        tone: "silver",
        columns: ["น้ำหนัก", "กรัม", "น้ำหนัก", "กรัม"],
        ...
        colAlign: ["left", "right", "left", "right"],
        rows: [
          ["1 สลึง", "3.811", "5 บาท", "76.22"],
          ["2 สลึง", "7.622", "10 บาท", "152.44"],
      ...
      },
      {
        ...
        inputs: [{ id: "baht", label: "จำนวน", suffix: "บาท" }],
        compute: ({ baht }) => {
          const fmt = (n: number) =>
    ...
    blocks: [
      {
        ...
        formula:
          "(ราคาขายออกทองคำแท่ง 96.5% × 103.6%) × 0.0656 + ค่าแรง = ราคาขาย/กรัม",
      },
      {
        type: "live-example",
        ...
        compute: ({ sell }) => {
          ...
          return {
            given: [
              `ราคาขายออกทองคำแท่ง 96.5% วันนี้ ${fmt(sell)} ฿/บาท`,
              `ค่าแรง ${fmt(labor)} ฿`,
    ...
    blocks: [
      { type: "h3", text: "วิธีการคำนวณราคาขายทอง 96.5%" },
      {
        ...
        rows: [
          [
            "0.6 กรัม",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.0656 × 0.6) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "1 กรัม",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.0656 × 1) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "½ สลึง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.125) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "1 สลึง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.25) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "2 สลึง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.50) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "3 สลึง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.75) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          ["1 บาท", "ราคาขายออกทองคำแท่ง 96.5% + ค่าแรง/ค่าบล็อก = ราคาขาย"],
          [
            "6 สลึง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 1.50) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
          [
            "2 บาท ขึ้นไป",
            "(ราคาขายออกทองคำแท่ง 96.5% + ค่าแรง/ค่าบล็อกต่อบาท) × จำนวนบาท = ราคาขาย",
          ],
          [
            "ตามน้ำหนักชั่ง",
            "(ราคาขายออกทองคำแท่ง 96.5% × 0.0656 × น้ำหนักสินค้า) + ค่าแรง/ค่าบล็อก = ราคาขาย",
          ],
        ],
      },
      { type: "sell-price-96-table" },
      {
        ...
        compute: ({ gold, labor, grams }) => {
          ...
          return [
            {
              label: "ราคาขายออกทองคำแท่ง 96.5% ตามน้ำหนักสินค้า",
              value: goldPart,
              format: "currency",
    ...
    blocks: [
      {
        ...
        formula:
          "ราคาขายออกทองคำแท่ง 96.5% × 0.0656 × น้ำหนักสินค้า + ค่าแรง = ราคาขาย",
      },
      {
        type: "calculator",
        title: "ราคาขายทอง 90",
    ...
    blocks: [
      {
        ...
        label: "ตามน้ำหนักชั่ง",
        formula:
          "(ราคาขายออกทองคำแท่ง 96.5% × 0.50) × 0.0656 × น้ำหนักสินค้า + ค่าแรง = ราคาขาย",
      },
      {
        type: "calculator",
        title: "ราคาขายนาก",
        ...
        compute: ({ gold, grams, labor }) => {
          ...
          return [
            {
              label: "ราคาขายออกทองคำแท่ง 96.5% × 0.50",
              value: half,
              format: "currency",
              hint: `${fmt(gold)} × 0.50`,
            },
    ...
    blocks: [
      {
        ...
        label: "ตามน้ำหนักชั่ง",
        formula:
          "(ราคาขายออกเงินแท่ง 99.99% × น้ำหนักสินค้า) + ค่าแรง/ค่าบล็อก = ราคาขาย",
      },
      {
        type: "calculator",
        title: "ราคาขายเงิน",
  ...
  /* ── 3.5 ค่าเปลี่ยน นน. เท่ากัน เริ่มต้น ── */
  {
    ...
    blocks: [
      {
        type: "p",
        text: "ค่าเปลี่ยนระหว่างน้ำหนักเท่ากัน — อิงราคาขายออกทองคำแท่ง 96.5% วันนี้ อัปเดตอัตโนมัติ",
      },
  ...
  /* ── 4. ค่าเปลี่ยน ── */
  {
    ...
    blocks: [
      { type: "h3", text: "น้ำหนักเพิ่มขึ้น 0.6 กรัม ถึง 2 สลึง" },
      {
        type: "formula",
        formula:
          "ราคาขายออกทองคำแท่ง 96.5% ของน้ำหนักที่เพิ่ม + ค่าแรงของน้ำหนักที่เพิ่ม (MD) + ค่าเปลี่ยนทองเก่า",
      },
      {
        type: "live-example",
      ...
      { type: "h3", text: "น้ำหนักเพิ่มขึ้น 1 บาท ขึ้นไป" },
      {
        type: "formula",
        formula:
          "ราคาขายออกทองคำแท่ง 96.5% ของน้ำหนักที่เพิ่ม + ค่าแรงของน้ำหนักที่เพิ่ม (MD) + ค่าเปลี่ยนทองเก่า (MD)",
      },
      {
        type: "live-example",
  ...
  /* ── ส่วนลด ── */
  {
    ...
    blocks: [
      ...
      },
      {
        type: "callout",
        tone: "warn",
        text: "ทองคำแท่ง 96.5% ไม่ได้ร่วมรายการ ส่วนลด",
      },
      ...
      },
      {
        type: "callout",
        tone: "warn",
        text: "เงินแท่ง 99.99% ไม่ได้ร่วมรายการ ส่วนลด",
      },
    ],
  },
    ...
    blocks: [
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง 96.5% − 3-5%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
      {
        ...
        compute: ({ gold, discount, grams }) => {
          ...
          return [
            {
              label: "ราคารับซื้อทองคำแท่ง 96.5% หลังหัก %",
              value: base,
              format: "currency",
    ...
    blocks: [
      {
        type: "callout",
        tone: "warn",
        text: "ทองแท่ง (MD) 96.5% ไม่หัก % รับซื้อ ให้เต็มตาม ราคารับซื้อทองคำแท่ง 96.5%\nหากเป็นของที่อื่น น้ำหนักสินค้า 0.05 กรัม - 1 บาท หัก 100 ฿/แท่ง และ 2 บาทขึ้นไป หัก 100 ฿/บาท",
      },
      { type: "h3", text: "วิธีการคำนวณราคารับซื้อทองรูปพรรณ" },
      {
        ...
        rows: [
          [
            "0.6 กรัม",
            "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.0656 × 0.6 = ราคารับซื้อ",
          ],
          ["1 กรัม", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.0656 × 1 = ราคารับซื้อ"],
          ["½ สลึง", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.125 = ราคารับซื้อ"],
          ["1 สลึง", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.25 = ราคารับซื้อ"],
          ["2 สลึง", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.50 = ราคารับซื้อ"],
          ["3 สลึง", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.75 = ราคารับซื้อ"],
          ["1 บาท", "ราคารับซื้อทองคำแท่ง 96.5% − 5-7% = ราคารับซื้อ"],
          ["6 สลึง", "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 1.5 = ราคารับซื้อ"],
          [
            "2 บาท ขึ้นไป",
            "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × จำนวนบาททอง = ราคารับซื้อ",
          ],
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง 96.5% − 5-7%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
    ...
    blocks: [
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง 96.5% × 60%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
          [
            "มีการตรวจ %",
            "(ราคารับซื้อทองคำแท่ง 96.5% × (%จริง − 10)%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
      {
    ...
    blocks: [
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อทองคำแท่ง 96.5% × 25%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
          [
            "มีการตรวจ %",
            "(ราคารับซื้อทองคำแท่ง 96.5% × (%จริง − 10)%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อ",
      ...
      },
      {
        ...
        compute: ({ buy }) => {
          ...
          return {
            given: [
              `ราคารับซื้อทองคำแท่ง 96.5% วันนี้ ${fmt(buy)} ฿/บาท`,
              `น้ำหนักสินค้า ${grams} กรัม`,
              "กรณี: ทั่วไป (25%)",
            ],
            steps: [
              {
                ...
                meaning: "ราคารับซื้อทองคำแท่ง 96.5% หลังหัก 75%",
              },
              {
    ...
    blocks: [
      {
        type: "callout",
        tone: "warn",
        text: "เงินแท่ง (MD) 99.99% ไม่หัก % รับซื้อ ให้เต็มตาม ราคารับซื้อเงินแท่ง 99.99%\nหากเป็นของที่อื่น น้ำหนักสินค้า 1 สลึง - 1 บาท หัก 100 ฿/แท่ง และ 2 บาทขึ้นไป หัก 100 ฿/บาท",
      },
      { type: "h3", tone: "silver-text", text: "วิธีการคำนวณราคารับซื้อเงิน" },
      {
        ...
        rows: [
          [
            "ตามน้ำหนักชั่ง",
            "(ราคารับซื้อเงินแท่ง 99.99% × 75%) × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
          [
            "มีการตรวจ %",
            "(ราคารับซื้อเงินแท่ง 99.99% × (%จริง − 20)%) × น้ำหนักสินค้า = ราคารับซื้อ",
          ],
        ],
      },
      {
        ...
        compute: ({ rate, mode, realPct, grams }) => {
          ...
          return [
            {
              label: "ราคารับซื้อเงินแท่ง 99.99% หลังหัก %",
              value: base,
              format: "currency",
              hint:
  ...
  {
    id: "block-cost",
    title: "ค่าบล็อก (ทองคำแท่ง 96.5% / เงินแท่ง 99.99%)",
    Icon: IconPackage,
    blocks: [
      {
        type: "p",
    ...
    blocks: [
      {
        ...
        colAlign: ["left", "left"],
        rows: [
          ["ทอง 99.99%", "หัก 15-20% จากราคารับซื้อทองคำแท่ง 96.5%"],
          ["ทอง 96.5%", "หัก 15-20% จากราคารับซื้อทองคำแท่ง 96.5%"],
          [
            "ทอง 90",
            "หัก 40-50% จากราคารับซื้อทองคำแท่ง 96.5% · หากมีการตรวจ % หักจาก % ที่ได้จากเครื่องตรวจ 25%",
          ],
          [
            "นาก",
            "หัก 80-85% จากราคารับซื้อทองคำแท่ง 96.5% · หากมีการตรวจ % หักจาก % ที่ได้จากเครื่องตรวจ 25%",
          ],
          [
            "เงิน 99.99%",
            "หัก 30-35% จากราคารับซื้อเงินแท่ง 99.99% · หากมีการตรวจ % หักจาก % ที่ได้จากเครื่องตรวจ 35%",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        compute: ({ silverBuy }) => {
          ...
          return {
            given: [
              `ราคารับซื้อเงินแท่ง 99.99% วันนี้ ${fmt(silverBuy)} ฿/กรัม`,
  ...
  /* ── 8. แต้มสะสม ── */
  {
    ...
    blocks: [
      ...
      { type: "h3", text: "สะสมแต้ม แลก ทองคำแท่ง 96.5%" },
    ...
    blocks: [
      {
        type: "callout",
        tone: "warn",
        text: "เปลี่ยนฟรีได้ ภายใน 7 วัน ต้องมีใบรับประกันจากทางร้าน และสินค้าต้องอยู่ในสภาพเดิม 100% เท่านั้น",
      },
      {
        type: "list",
        items: [
          "ทองรูปพรรณ 96.5% ต้องเปลี่ยน **น้ำหนักที่เท่ากัน** เท่านั้น",
          "หากเปลี่ยน MD เท่ากัน หรือ น้อยกว่า **ไม่ต้องเพิ่มเงิน**",
          "หากเปลี่ยน MD มากกว่า **ต้องเพิ่มเงิน** เท่ากับ ส่วนต่าง MD (น้ำหนัก ≥ 2 บาท คูณจำนวนบาทด้วย)",
        ],
      },
  ...
  /* ── 11. รูดบัตรเป็นเงินสด ── */
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        inputs: [{ id: "amount", label: "ยอดรูดเต็ม", suffix: "฿" }],
        compute: ({ amount }) => {
          const fmt = (n: number) =>
            n.toLocaleString("th-TH", { maximumFractionDigits: 2 });
          return [
  ...
  /* ── 12. ภาษี VAT ── */
  {
    ...
    blocks: [
      { type: "h3", text: "วิธีคำนวณ VAT นอก" },
      {
        ...
        ordered: true,
        items: [
          "(ราคาขายออกทองคำแท่ง 96.5% × 0.0656 × น้ำหนักสินค้า) + ค่าแรง (ตามตาราง) = ราคาขาย",
          "(ราคารับซื้อทองคำแท่ง 96.5% × 98%) × 0.0656 × น้ำหนักสินค้า = ราคารับซื้อคืน (VAT)",
      ...
      },
      {
        ...
        compute: ({ sell, buy, laborBaht }) => {
          ...
          // ราคารับซื้อคืน (VAT) = ราคารับซื้อทองคำแท่ง 96.5% × 98%
      ...
      },
      {
        ...
        inputs: [
          ...
          {
            id: "buyback",
            label: "ราคารับซื้อทองคำแท่ง 96.5% × 98%",
            defaultValue: 63994,
            suffix: "฿/บ.",
            buyPriceDefault: true,
        ...
        compute: ({ gold, labor, weight, buyback }) => {
          ...
          return [
            ...
            },
            {
              ...
              value: buybackVat,
              format: "currency",
              hint: `(ราคารับซื้อทองคำแท่ง 96.5% × 98%) × 0.0656 × ${weight}`,
            },
            {
  ...
  /* ── 15. AEON i-Dealer ── */
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        caption: "หน้าแรกหลัง login",
      },
      {
        type: "image",
        src: "/knowledge/aeon-menu.jpg",
        alt: "เมนูบริการ",
        caption: "1. เข้าเมนู บริการ → ทำรายการผ่อนชำระ (คิวอาร์โค้ด)",
      },
      {
        type: "image",
        ...
        caption:
          "2. เลือกโปรแกรมการชำระ · 3. ใส่จำนวนเงิน · 4. ใส่จำนวนงวด · 5. กดส่งข้อมูล",
      },
      {
        type: "image",
        src: "/knowledge/aeon-qr-blurred.png",
        alt: "QR Code ให้ลูกค้าสแกน",
        caption: "6. ให้ลูกค้า scan QR จ่ายเงินผ่านมือถือ",
      },
  ...
  /* ── 31. แบบทดสอบความรู้พื้นฐาน (ADMIN เท่านั้น) ── */
  {
    id: "basic-exam",
    title: "แบบทดสอบความรู้พื้นฐาน",
    Icon: IconClipboardCheck,
    // ข้อสอบจริงที่ใช้วัดพนักงาน — พนักงานเห็นล่วงหน้าไม่ได้
    adminOnly: true,
    blocks: [
      {
        type: "callout",
        tone: "warn",
        text: "ทั้งหมด 30 ข้อ · เวลา 100 นาที · ใช้เครื่องคิดเลขในการคำนวณได้\nทุกข้ออ้างอิงจากราคาทองคำแท่ง ณ วันที่ทำข้อสอบ\nทุกข้อต้องแสดงวิธีคิดคำนวณ และอธิบายคำตอบให้ชัดเจน\nเกณฑ์ผ่าน 80% ของจำนวนข้อสอบทั้งหมด (ไม่รวมความรู้รอบตัว)",
      },
      { type: "h3", text: "ข้อสอบ (30 ข้อ)" },
      {
        type: "list",
        ordered: true,
        items: [
          "กรุณาเขียนน้ำหนักทองที่ถูกต้องตาม สคบ. ตั้งแต่ 1 กรัม จนถึง 10 บาท",
          "เขียนค่ากำเหน็จทองลายมาตรฐานตั้งแต่ 1 กรัม ถึง 10 บาท",
          "ถ้าลูกค้าต้องการซื้อข้อมือเบนซ์คั่นปะคำ (MD-01) หนัก 1 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ถ้าลูกค้านำแหวน 0.6 กรัม 5 วง และแหวน 1 กรัม 1 วง สภาพยังไม่ได้ใช้งานแต่ไม่ได้ซื้อจากที่ร้าน ลูกค้าต้องการมาเปลี่ยนเป็นแหวน หนัก 1 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้านำสร้อยคอลายผ่าหวายสภาพเก่ามากมีแป้งติดตามร่อง หนัก 23.6 กรัม ลูกค้าต้องการนำมาเปลี่ยนเป็นสร้อยคอ หนัก 1 บาท และ แหวน หนัก 2 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร และ พนักงานต้องทำอย่างไรก่อนบอกราคาลูกค้า",
          "ลูกค้ามีสร้อยคอเชือกสภาพใช้งานหนักมากเชือกดูค่อนข้างเก่า หนัก 2 สลึง (เราจะดูน้ำหนักคอเชือกจะมีวิธีดูอย่างไรถ้าลูกค้าไม่ต้องการให้ตัดเชือก เพราะลูกค้าต้องการทราบราคาคร่าวๆ ก่อนตัดสินใจเปลี่ยน) ลูกค้าต้องการนำมาเปลี่ยนเป็นคอเชือกแบบห้อยพระได้สามองค์ (MD-03) หนัก 1 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีสร้อยคอลายมีนา (สภาพใช้งาน) หนัก 44.63 กรัม และ ข้อมือกึ่งกำไล หนัก 15.16 กรัม ลูกค้าต้องการนำมาเปลี่ยนเป็นสร้อยคอระย้าลายสี่เสาตันห้อยหัวใจ (MD-02) หนัก 5 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร (ลูกค้ามีบัตรสมาชิก)",
          "ลูกค้ามีแหวนทองปอกมีดตัน หนัก 3.68 กรัม และ ข้อมือลายบิดนูนตัน หนัก 7.58 กรัม ลูกค้าต้องการนำมาเปลี่ยนเป็นสร้อยคอลายเบนซ์ หนัก 3 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีต่างหูดอกไม้ หนัก 3.79 กรัม ลูกค้าต้องการนำมาเปลี่ยนเป็นแหวน 1 กรัม 4 วง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร (ลูกค้ามีบัตรสมาชิก)",
          "ลูกค้ามีแหวนลายโปร่งมาตรฐาน หนัก 1.89 กรัม และ แหวนตัดลายรอบวง หนัก 1.88 กรัม ลูกค้าต้องการนำมาเปลี่ยนเป็นสร้อยมือ 1 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ถ้าลูกค้ามีสร้อยลายทาโร่ หนัก 30.32 กรัม ลูกค้าต้องการมาเปลี่ยนเป็นกำไลมังกรคู่คาบแก้ว (MD-03) หนัก 3 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีแหวน 1 กรัม 5 วง ชั่งน้ำหนักได้ 4.5 กรัม ลูกค้าต้องการมาเปลี่ยนเป็นแหวนครึ่งสลึง 2 วง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีแหวนครึ่งสลึง 3 วง รวมน้ำหนัก 5.24 กรัม ลูกค้าต้องการมาเปลี่ยนสร้อยข้อมือลายประคำเกลี้ยง หนัก 2 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีสร้อยทอง หนัก 30.4 กรัม ลายห่วงคู่โปร่งคั่นปล้อง สภาพมีแป้งติดตามร่องค่อนข้างเยอะ ลูกค้าต้องการมาเปลี่ยนเป็นสร้อยคอลายเบนซ์ หนัก 6 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร (ลูกค้ามีบัตรสมาชิก)",
          "ลูกค้าเพิ่งซื้อทองไปเป็นสร้อยข้อมือหลุยส์ หนัก 1 บาท ลูกค้าซื้อไปเป็นระยะเวลา 1 อาทิตย์ สร้อยข้อมือมีรอยบุบตามห่วงและสร้อยขาด ลูกค้าต้องการเปลี่ยนฟรี เพราะบอกว่าบุบมาจากที่ร้าน พนักงานจะมีวิธีบอกลูกค้าอย่างไรให้ลูกค้ารู้สึกดี (โปรดอธิบาย)",
          "ถ้าลูกค้าซื้อสร้อยคอลายคอตกิตธรรมดา หนัก 1 บาท แต่ลูกค้าอยากได้ของแถมเป็นร่ม พนักงานจะมีวิธีบอกลูกค้าอย่างไรไม่ให้ลูกค้ารู้สึกเสียใจที่ไม่ได้ของแถมเป็นร่ม พูดอย่างไรให้ประนีประนอมที่สุด",
          "ลูกค้ามีสร้อยคอสองสี หนัก 34.6 กรัม ลูกค้าต้องการเปลี่ยนเป็นสร้อยคอลายเบนซ์หัวมังกร (MD-03) หนัก 5 บาท ลูกค้าต้องการจ่ายเป็นเงินสด 35,000 บาท และส่วนที่เหลือจ่ายเป็นบัตรเครดิต ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีสร้อยคอทั้งหมด 2 เส้น เส้นแรกหนัก 11.38 กรัม และ เส้นที่สองหนัก 11.4 กรัม ลูกค้าต้องการเปลี่ยนเป็นลายผ่าหวาย หนัก 6 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ถ้าลูกค้ามีสร้อยคอสภาพขาด หนัก 5.69 กรัม ต้องการเปลี่ยนเป็นกำไล (MD-02) หนัก 1 บาท ลูกค้ามีบัตรสมาชิก 3 ใบ ลูกค้าจะได้ส่วนลดกี่เปอร์เซ็นต์ และ ต้องเสียค่าใช้จ่ายเท่าไหร่",
          "ลูกค้ามี กำไล หนัก 7.56 กรัม ลูกค้าต้องการเปลี่ยนเป็นข้อมือลายแพเบนซ์ (MD-03) หนัก 1 บาท ลูกค้าต้องการรูดบัตร 2,000 บาท ลูกค้าต้องเสียค่าใช้จ่ายรวมทั้งหมดเท่าไร",
          "ลูกค้ามีแหวน หนัก 7.6 กรัม ลูกค้าต้องการเปลี่ยนเป็น แหวน 1 กรัม 8 วง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีแหวนประดับเพชรสวิช หนัก 1 สลึง 4.2 กรัม มีใบรับประกัน นน. ทองตอนซื้อ 4.5 กรัม ลูกค้าต้องการมาเปลี่ยนเป็นแหวนลายมังกรฉลุ (MD-02) หนัก 1 สลึง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ถ้าลูกค้าถามว่าพระแผงขายคืนได้ไหม พระแผงเป็นทองอะไร เป็นทองคำแท้หรือเปล่า พนักงานจะอธิบายอย่างไร ให้ลูกค้าน่าซื้อไปใส่",
          "ลูกค้ามีสร้อยคอ หนัก 3.79 กรัม 2 เส้น และ แหวน 7.58 กรัม 1 วง เป็นทองใหม่ได้มาจากการทำแชร์เพิ่งได้รับไปไม่ถึง 3 วัน ลูกค้าต้องการมาเปลี่ยนเป็นสร้อยคอลายเบนซ์ (MD-01) หนัก 1 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีสร้อยข้อมือ หนัก 75.8 กรัม ลูกค้าต้องการมาเปลี่ยนเป็นกำไลทองกลมเกลี้ยง หนัก 5 บาท ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร ถ้าลูกค้านำแหวน หนัก 1.68 กรัม มาขายคืนเพื่อหักป็นค่าเปลี่ยนด้วย ดังนั้นลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามาซื้อสร้อยคอ หนัก 3 บาท ต้องการผ่อนผ่านบัตรเครดิต กรุงศรี 6 เดือน ลูกค้าจะต้องเสียค่าใช้จ่าย เดือนล่ะเท่าไหร่ รวมแล้ว 6 เดือน ลูกค้าต้องเสียค่าใช้จ่ายทั้งหมดเท่าไหร่",
          "ลูกค้ามี สร้อยคอหนัก 1 บาท ลูกค้าต้องการเปลี่ยนเป็นกำไลข้อเท้าเด็ก (MD-01) หนัก 2 สลึง จำนวน 1 คู่ ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "ลูกค้ามีกำไล ตะปูแปะแผ่นทอง หนัก 0.1 กรัม ต้องการมาเปลี่ยนเป็นแหวน หนัก 1 สลึง แต่ลูกค้ามีแต้มครบแล้ว 30 แต้ม ลูกค้าต้องการนำแต้ม มาแลกเป็นส่วนลดในการเปลี่ยนครั้งนี้ด้วย ลูกค้าต้องเสียค่าใช้จ่ายเท่าไหร่",
          "ลูกค้ามีสร้อยคอเก่ามาก สร้อยพัง ขาด มีแป้งติดเยอะ หนัก 73.8 กรัม ลูกค้าต้องการมาเปลี่ยนเป็นสร้อยคอ หนัก 2 บาท 1 เส้น ข้อมือ 1 บาท ลงยาแดงดอกไม้ขาว (MD-08) 1 เส้น แหวน 1 สลึง 3 วง และ แหวน 2 สลึง ลายมังกรฉลุประดับเพชรสวิช (MD-06) 1 วง ลูกค้าต้องเสียค่าใช้จ่ายเท่าไร",
          "กรุณาเขียนโปรโมรชั่นใหม่ๆ เพื่อเพิ่มยอดไลค์ทางโซเชียลมีเดีย หรือ เพิ่มยอดขายให้ห้างเพชรทองมุกดา",
        ],
      },
      { type: "h3", text: "ความรู้รอบตัว / ความรู้พื้นฐาน" },
      {
        type: "p",
        text: "ส่วนนี้ไม่นำมาคิดในเกณฑ์ผ่าน 80%",
        muted: true,
      },
      {
        type: "list",
        ordered: true,
        items: [
          "ถ้าลูกค้าถามว่า “จำนำทองไว้ 2 บาท 53,000 บาท ผ่านมา 12 วันแล้ว ต้องการไถ่ออก เสียดอกเบี้ยกี่เปอร์เซ็นต์ และ เป็นจำนวนเงินรวมทั้งหมดเท่าไร”",
          "ถ้าลูกค้ามีต่างหูทอง 90% ห้อยชาแนล หนัก 2.25 กรัม ลูกค้าต้องการขายคืน จะได้เงินคืนเท่าไร",
          "ถ้าลูกค้าถามว่าเพชรสวิช คืออะไร (โปรดอธิบายลูกค้าให้เข้าใจ)",
          "ทองหุ้ม คืออะไร ถ้าลูกค้าถามว่าลอกไหมจะตอบอย่างไรให้ฟังดูดี",
          "ลูกค้าต้องการมาไถ่ออก โดยที่เจ้าของบัตรไม่ได้มาด้วย แต่ลูกค้าไม่พอใจที่ไม่ให้ไถ่ออก เราจะแนะนำลูกค้าอย่างไรได้บ้าง",
          "ถ้าลูกค้า ถามว่า สร้อยคอ ที่เป็น 2 สี สีขาวคืออะไร ทำมาจากอะไร",
        ],
      },
    ],
  },
...
/** section ที่ผู้ใช้คนนี้เห็นได้ — gate เดียวของ `adminOnly` ระดับ section
 *
 *  แยกออกมาเป็น pure function (ไม่ใช่ inline ใน KnowledgeView) เพราะถ้า
 *  พลาดแล้วพนักงานเห็นข้อสอบล่วงหน้า มันพังเงียบๆ ไม่มี error ให้จับ
 *  → มีเทสต์คุมที่ `knowledgeVisibility.test.ts`                          */
export function visibleKnowledgeSections(
  sections: KnowledgeSection[],
  isAdmin: boolean | undefined,
): KnowledgeSection[] {
  return sections.filter((s) => !s.adminOnly || isAdmin === true);
}

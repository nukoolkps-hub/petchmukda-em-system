...
function TabButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 rounded-[10px] text-sm font-bold cursor-pointer font-[inherit] transition-colors border-[1.5px] ${
        active

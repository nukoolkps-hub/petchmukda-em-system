      ...
      <div className="mb-3 p-3 rounded-[10px] bg-[#F5E6C860] border border-[#C9973A30] flex items-start gap-2.5">
        ...
        <span className="flex-1 min-w-0">
          ...
          <span className="block text-xs text-txt-soft mt-0.5">
            ...
            ในวันนั้นจะไม่ถูกจัดหน้าที่อื่นเลย · ถ้าเขาเป็นคนหลักของหน้าที่อื่นอยู่ เวรยังเป็นของเขา
            เหมือนเดิม แค่วันนั้นมีคนมาทำแทน (การ์ดขึ้น "แทน X (ติดหน้าที่อื่น)") ลำดับเวรไม่เลื่อน
    ...
    <>
      ...
      >
        ...
        <span className="flex-1 min-w-0">
          ...
          <span className="block text-xs text-txt-soft mt-0.5">
            คนที่ทำหน้าที่นี้ในวันนั้น — ไม่ว่าจะเป็นคนหลักหรือคนแทน — จะไม่ถูกจัดหน้าที่อื่น
            ในวันเดียวกัน · ถ้าเขาเป็นคนหลักของหน้าที่อื่นอยู่ เวรยังเป็นของเขาเหมือนเดิม
            แค่วันนั้นมีคนมาทำแทน (การ์ดขึ้น "แทน X (ติดหน้าที่อื่น)") ลำดับเวรไม่เลื่อน ·
            ยกเว้นวันที่คนมาทำงานน้อยกว่าจำนวนหน้าที่ ระบบจะยอมให้ทำซ้อนแทนที่จะปล่อยหน้าที่ว่าง
          </span>
        </span>
      </button>

        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <b className="text-red">ถ้าเดือนก่อนเงินสุทธิติดลบ</b> →
                ระบบจะ <b>ยกยอดติดลบเป็นเบิกล่วงหน้าเดือนนี้อัตโนมัติ</b>
                (หักจากเงินเดือนเดือนนี้) + <b>บล็อกการยื่นเบิกใหม่</b>
                (กัน chain หนี้สะสม) · ADMIN กด "อนุญาตให้ยื่นเบิกใหม่"
                ใน "สรุปเงินเดือน" เพื่อปลดเฉพาะการบล็อก (ไม่ได้เคลียร์ยอด ·
                auto-carry ยังหักปกติ)
              </li>
              <li>
          ...
          >
            ...
            <ul>
              ...
              <li>
                ระบบจะ <b>แจ้ง LINE</b> ให้พนักงานคนนั้นทันที (พร้อมรูปสลิป
                ถ้าแนบไว้)
              </li>
              <li>
                พนักงานเปิดดูสลิปย้อนหลังได้จาก <b>ปุ่ม "สลิป"</b> มุมขวาบนของ
                card เงินกู้ในหน้า "เงินเดือน"
              </li>
            </ul>
            <Card
              title={
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <b>รายละเอียดทั้งหมด</b> (ค่าเริ่มต้น) — พิมพ์ทุกรายการที่
                    ADMIN ยืนยันแล้ว
                  </li>
                  <li>
                    <b>รายละเอียดบางส่วน</b> — tick เลือกเฉพาะรายการที่ต้องการ ·
                    ที่ tick ออก อาจจะถูก <b>รวมไว้ในบรรทัด</b> "รายรับอื่นๆ" /
          ...
          >
            ...
            <ul>
              ...
              <li>
                <b>ระบุเงินเดือนเองได้</b> — เว้นว่าง = ใช้ "เงินเดือนพื้นฐาน
                ปัจจุบัน" · กรอกได้ถ้าอยากระบุยอด <b>ต่ำกว่าจริง</b>{" "}
                (เช่น ไม่อยากโชว์ยอดเต็มในใบสมัครบัตรเครดิต) ·{" "}
                <b className="text-red">ห้ามกรอกมากกว่าจริง</b> —
                ระบบจะ clamp ลงให้อัตโนมัติ
              </li>
              <li>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <Box bg={COLORS.cream} border={COLORS.border}>
              ...
              → <b>พนักงาน A</b> ยังทำต่อจนวันอาทิตย์ ·
              สัปดาห์หน้าค่อยหมุนถัดไปตามลำดับ (อาจถึงคิว <b>พนักงาน B</b>)
              <br />
              <b>หน้าที่รายเดือน</b> "Online" — มิถุนายนคือ
              <b> พนักงาน C</b> · วันที่ 15 มิถุนายน <b>พนักงาน C</b> ลาป่วย
              → ระบบเลือกคนแทนเฉพาะวันนั้น · กรกฎาคมค่อยหมุนไปคนถัดไป
              (ไม่ใช่ <b>พนักงาน C</b> รอบ 2 ติด)
            </Box>
          </Section>

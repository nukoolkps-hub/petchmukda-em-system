    ...
    >
      ...
      {tab === "leave" && (
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          <Section
            ...
            color={COLORS.maroon}
          >
            <p>บอทจะประกาศรายชื่อคนหยุดเข้ากลุ่ม LINE ให้ทีมรู้ว่าวันนี้ขาดใครบ้าง</p>
            <ul>
              <li>
                <b>07:30 — สรุปประจำวัน</b> รวมรายชื่อคนหยุดวันนั้น (ตามใบลาที่ยื่นไว้
                ก่อนเวลานี้)
              </li>
              <li>
                <b>08:30 — "มีคนลาเพิ่ม"</b> ตามแจ้งเฉพาะ<b>คนที่กดลาหลัง 07:30</b>{" "}
                เพราะไม่ทันกล่องเช้า · ไม่มีใครกดลาเพิ่ม = ไม่ส่ง
              </li>
              <li>
                <b>09:30 — "มีคนลาเพิ่ม" อีกรอบ</b> ตามแจ้งเฉพาะ
                <b>คนที่กดลาหลัง 08:30</b> · ชื่อที่ประกาศไปแล้วจะไม่ซ้ำ
              </li>
              <li>เสาร์ที่ร้านปิดตามปกติ ไม่ส่งทั้ง 3 รอบ</li>
            </ul>
            <p className="mt-1.5 text-xs text-txt-soft">
              กดลาล่วงหน้าได้เปรียบ — ชื่อจะอยู่ในกล่องเช้ารอบเดียว ทีมวางแผนงานได้ทัน ·
              กดสายกว่านั้นชื่อจะไปโผล่รอบตาม ซึ่งแทรกกลางงานของทุกคน
            </p>
          </Section>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            <p>
              ...
              <b>คูณกับเรทของตัวเอง</b> ได้เลย · ลาก็ไม่กระทบเงินตรงนี้
            </p>
            <p className="mt-2 text-xs text-txt-soft inline-flex items-start gap-1">
              <IconSettings
                size={12}
          ...
          >
            <p>
              ...
              <b>ไม่นับเข้าค่าคอม</b> — ADMIN จะมาใส่ <b>"รายการยกเว้นค่าคอม"</b>{" "}
              ในแต่ละเดือน (ใส่ได้แยกตามรายการขาย เช่น "ขายทั่วไป" / "รับซื้อ" /
              "ขายมือสอง")
            </p>
            <ul>
              <li>
          ...
          >
            ...
            >
              ...
              <div className="mt-2.5 rounded-[10px] bg-cream/70 border border-bdr p-2.5 text-xs leading-relaxed">
                ...
                <div className="text-txt-mid">
                  <b>ขายทั่วไป</b> มีคนที่ทำได้สูงสุดของตัวเอง · เช็ค 80%
                  เทียบกับยอดขายทั่วไปอย่างเดียว
                  <br />
                  <b>รับซื้อ</b> มีคนที่ทำได้สูงสุดของตัวเอง · เช็ค 80%
            ...
            >
              <ul>
                ...
                <li>
                  <b>ปิดกองกลางทั้งหมด</b> — ไม่ได้แบ่งกองในทุกรายการ
          ...
          <Box bg={COLORS.goldPale} border={`${COLORS.gold}40`}>
            ...
            <div className="mt-3 pt-2 border-t border-[#C9973A40] text-xs text-txt-soft leading-relaxed inline-flex items-start gap-1">
              ...
              />
              <span>
                ลาไม่เกิน 2 วัน = ไม่กระทบเงิน · ลาเกินจะถูกหักไปแบ่งให้เพื่อนร่วมงานที่ไม่ลา
              </span>
            </div>
          </Box>
          ...
          >
            ...
            <p className="mt-2">
              <b>สูตร:</b> เรทของตัวเอง × จำนวนที่ทำได้ในเดือนนั้น
            </p>
            ...
            <p className="mt-2.5 text-xs text-txt-soft inline-flex items-start gap-1">
              ...
              <span>
                ...
                "ชวนเพื่อนสมัคร LINE" ฯลฯ) — แต่ละรายการตั้งเรทของแต่ละคนได้
              </span>
            </p>
          </Section>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              <li>
                ...
                <div className="mt-1.5 mb-2.5 rounded-[8px] border border-bdr bg-cream/50 overflow-hidden text-xs">
                  <div className="grid grid-cols-2 gap-px bg-bdr/50">
                    ...
                    <div className="bg-white px-2 py-1 text-right font-bold">
                      50%
                    </div>
              ...
              <li>
                ...
                <b>ยกยอดติดลบเป็นเบิกล่วงหน้าในเดือนถัดไปอัตโนมัติ</b>{" "}
                (หักจากเงินเดือนเดือนถัดไป) + <b>บล็อกการยื่นเบิกใหม่</b> (กันหนี้สะสมต่อเนื่อง)
                · ADMIN กด "อนุญาตให้ยื่นเบิกใหม่" ใน "สรุปเงินเดือน" เพื่อปลดเฉพาะการบล็อก
                (ไม่ได้เคลียร์ยอด · ระบบยังยกยอดมาหักปกติ)
              </li>
              <li>
              ...
              <li>
                <b>หักจากเงินเดือนเต็มยอด</b> ในเดือนที่เบิก · รอบเดียวจบ
              </li>
              <li>
          ...
          >
            ...
            <ul>
              ...
              <li>
                ระบบจะ <b>แจ้ง LINE</b> ให้พนักงานคนนั้นทันที (พร้อมรูปสลิป ถ้าแนบไว้)
              </li>
              <li>
                พนักงานเปิดดูสลิปย้อนหลังได้จาก <b>ปุ่ม "สลิป"</b> มุมขวาบนของการ์ด
                เงินกู้ในหน้า "เงินเดือน"
              </li>
            </ul>
            <Card
              title={
            ...
            >
              <ul>
                <li>
                  <b>หักทุกเดือน</b> ตามที่ ADMIN ตั้ง (ผ่อนเดือนละ X บาท) ·
                  หักอัตโนมัติจนครบ
                </li>
                <li>
      ...
      {tab === "lock" && (
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          <Section
            title={
              <span className="inline-flex items-center gap-1.5">
                ...
                ระหว่าง 7 วันแรก — แก้ได้ + คิดยอดใหม่ให้เอง
              </span>
            }
            color={COLORS.green}
          >
            <p>
              ยังแก้ได้ตามปกติ (พนักงานยื่นลาเพิ่ม · ADMIN เพิ่งคิดเพิ่ม · แก้
              เรท/ชิ้น/เบิก/เงินกู้/ปฏิทินร้าน ฯลฯ)
            </p>
            <ul>
              <li>
                แก้อะไรที่กระทบยอด → ระบบ <b>คำนวณยอดใหม่ให้อัตโนมัติทั้งเดือน</b>{" "}
                <b className="text-green">ไม่ต้องกด "ยืนยันยอดใหม่" เอง</b>
              </li>
              <li>
                <b>คิดใหม่ให้ทุกคนในกลุ่มกองกลาง</b> ไม่ใช่แค่คนที่แก้ —
                เพราะการเกลี่ยกองกลางกระทบยอดของเพื่อนทั้งกลุ่ม
              </li>
              <li>ยอดทางการ + สลิป อัปเดตทันที · ไม่มีแบนเนอร์ "ยอดเปลี่ยน" ค้าง</li>
            </ul>
          </Section>
          ...
          >
            <p>
              ทุกการแก้ที่กระทบยอดในช่วง 7 วัน ระบบ <b>บันทึกลงประวัติให้อัตโนมัติ</b> — ADMIN
              เปิดดูได้ที่ปุ่ม <b>"ประวัติ"</b> มุมขวาการ์ดเดือน ในหน้า "สรุปเงินเดือน"
            </p>
            <ul>
              <li>
                <b>เวลาที่แก้</b> + <b>ชื่อพนักงาน</b>
              </li>
              <li>
                <b>อะไรเปลี่ยน</b> — เช่น "ขายทั่วไป 39 → 29 ชิ้น" · "การปิดสิทธิ์กองกลาง:
                ไม่ปิด → ปิด: ขายทั่วไป"
              </li>
              <li>
                <b>ยอดรวมก่อน → หลัง</b> ของการแก้ครั้งนั้น
              </li>
            </ul>
            <p className="mt-1.5 text-xs text-txt-soft">
              โปร่งใส · ตรวจย้อนหลังได้ว่าใครแก้อะไรหลังจ่ายเงินไปแล้ว
            </p>
          </Section>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                สลิปมีรายละเอียดครบ: เงินเดือนพื้นฐานปัจจุบัน · ค่าคอม · โบนัส · รายการหัก ·
                เงินสุทธิ
              </li>
              <li>
                เลือก <b>"บันทึกเป็น PDF"</b> (Save as PDF) ในหน้าต่างพิมพ์ → ได้ไฟล์ PDF
                ค้นข้อความได้ · ฟอนต์ไทย Sarabun
              </li>
              <li>
                <b>เลือกรายการที่จะแสดง</b> — ตอนกดพิมพ์ มี 2 ตัวเลือก:
                <ul>
                  <li>
                    <b>รายละเอียดทั้งหมด</b> (ค่าเริ่มต้น) — พิมพ์ทุกรายการที่ ADMIN ยืนยันแล้ว
                  </li>
                  <li>
                    <b>รายละเอียดบางส่วน</b> — ติ๊กเลือกเฉพาะรายการที่ต้องการ · ที่ ติ๊กออก
                    อาจจะถูก <b>รวมไว้ในบรรทัด</b> "รายรับอื่นๆ" / "รายการหักอื่นๆ" บนสลิป
                    · <b>เงินสุทธิเท่าเดิม</b>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          >
            <p>
              ออกหนังสือรับรองเงินเดือนได้เอง — ปุ่ม <b>"ใบรับรอง"</b> บนแถบ
            ...
            <ul>
              ...
              <li>
                <b>ระบุยอดเองได้</b> — เว้นว่าง = ใช้ "เงินเดือนพื้นฐานปัจจุบัน"
              </li>
              <li>
                ระบุ <b>ต่ำกว่าได้เสมอ</b> (เช่น ไม่อยากโชว์ยอดเต็มในใบสมัครบัตรเครดิต)
              </li>
              <li>
                ระบุ{" "}
                <b>
                  สูงกว่าได้ถึง +
                  {Math.round(BUSINESS_RULES.CERT_MAX_OVER_BASE * 100)}%
                </b>{" "}
                ของเงินเดือนพื้นฐาน — เพราะใบนี้ระบุ <b>"รายได้เฉลี่ย"</b>{" "}
                ซึ่งรวมค่าคอมกองกลางและโบนัสที่ได้จริงด้วย ไม่ใช่เงินเดือนพื้นฐานล้วนๆ
              </li>
              <li>เกินเพดาน → กล่องขึ้นเตือนสีแดง และระบบใช้ยอดเพดานแทนให้อัตโนมัติ</li>
              <li>
          ...
          >
            ...
            <ul>
              ...
              <li>
                ADMIN <b>กำหนดเอง</b> เฉพาะปีได้ (เช่น ปีนี้ขึ้นพิเศษ หรือไม่ขึ้นปีหนึ่ง)
              </li>
            </ul>
            <p className="mt-2 text-xs text-txt-soft">
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            <p>
              ...
              จัดของแถม, ออนไลน์) ระบบ <b>หมุนเวียนคนอัตโนมัติ</b> ตามลำดับ —
          ...
          >
            ...
            >
              <ul>
                ...
                <li>
                  <b>รายเดือน</b> — สลับคนทุกเดือน (เช่น ออนไลน์)
                </li>
            ...
            >
              ...
              <p className="text-xs text-txt-soft mt-1.5">
                <b className="text-maroon">ผูกขาดคนทำอัตโนมัติ</b> — คนที่ถูกดึงมาแทน
                วันนั้นจะไม่ถูกจัดหน้าที่อื่นเลย (ต้องอยู่ประจำที่แทนทั้งวัน)
              </p>
            </Card>
          </Section>
          ...
          >
            <p>
              หน้าที่ที่ต้องอยู่กับที่ทั้งวัน (เช่น <b>ONLINE</b>, <b>บัญชี</b>) ADMIN เปิดตัวเลือก{" "}
              <b>"ผูกขาดคนทำ"</b> ได้ — คนที่ทำหน้าที่นั้นในวันนั้น{" "}
              <b>ไม่ว่าจะเป็นคนหลักหรือคนแทน</b> จะไม่ถูกจัดหน้าที่อื่นเลยในวันนั้น
            </p>
            <ul>
              <li>
                <b>เวรของเขาไม่ได้หายไป</b> — ถ้าเขาเป็นคนหลักของหน้าที่อื่นอยู่
                เขายังเป็นคนหลักของรอบนั้นเหมือนเดิม แค่วันนั้นมีคนมาทำแทน · การ์ดจะขึ้นว่า{" "}
                <b>"แทน (ชื่อ) (ติดหน้าที่อื่น)"</b> — ไม่ใช่ "(ลา)" เพราะเจ้าตัวมาทำงานปกติ
              </li>
              <li>
                รอบถัดไปเวรก็หมุนต่อตามลำดับเดิม <b>ไม่มีใครถูกข้าม</b>
              </li>
              <li>
                หน้าที่ <b>"แทนคนลา"</b> ผูกขาดอยู่แล้วเสมอ — ในหน้าแก้ไขจะขึ้นว่า{" "}
                <b>"ผูกขาดคนทำ — เปิดอยู่เสมอ"</b> กดปิดไม่ได้
              </li>
              <li>
                หน้าที่ <b>หมุนเวียน</b> ADMIN ติ๊กเองในหน้าแก้ไขหน้าที่ (ใต้ช่องชื่อหน้าที่) ·
                การ์ดหน้าที่จะขึ้นป้าย <b>"ผูกขาดคนทำ"</b>
              </li>
              <li>มี 2 หน้าที่ผูกขาด → ระบบจัดคนละคนเสมอ (ไม่ให้คนเดียวถือทั้งคู่)</li>
            </ul>
          </Section>
          ...
          >
            ...
            <ul>
              ...
              <li>
                <b>เห็นยอดทันที</b> — พอถูกเลือกเป็นคนแทน (จากใบลาที่ยื่นไว้) เงินค่าแทน
                จะโผล่ในหน้าเงินเดือนเลย <b>ไม่ต้องรอ ADMIN ยืนยันยอด</b> · ถ้าคนแทนลาเอง
                วันนั้นระบบเลือกคนถัดไป ยอดขยับตามสด
              </li>
              <li>
                แสดงในสลิปแยกบรรทัด <b>"เงินค่าแทน"</b> + <b>รายละเอียดแยกหน้าที่</b>
              </li>
          ...
          >
            <ul>
              ...
              <li>
                <b>รายเดือนเลือกคนแทนแบบไม่ซ้ำ</b> — คนทำรายเดือนคนเดิมทั้งเดือน
                ถ้าลาหลายครั้ง ระบบเลือก <b>คนที่เคยแทนน้อยสุดก่อน</b> (ไม่ใช่คนถัดไป
                คนเดิมทุกครั้ง) ให้กระจายกัน
              </li>
              <li>
              ...
              <li>
                <b>ตั้ง "ไม่ให้เป็นคนแทน" ได้</b> — ในหน้าแก้ไขหน้าที่ ADMIN เลือกได้ว่า บางคน{" "}
                <b>ยังหมุนเป็นเวรหลักได้ตามปกติ</b> แต่ไม่ให้ถูกดึงมาแทนตอนคนอื่นลา (ต่างจาก
                "ตัดออก" ที่เอาออกทั้งหมด)
              </li>
            </ul>
          </Section>
          ...
          >
            <ul>
              <li>
                ...
                หน้าที่พร้อมกัน (ยกเว้นวันที่คนมาทำงานน้อยกว่าจำนวนหน้าที่)
              </li>
              <li>
            ...
            <Box bg={COLORS.cream} border={COLORS.border}>
              <b className="text-maroon inline-flex items-center gap-1">
                <IconScale size={13} strokeWidth={2.4} />
                วันที่คนไม่พอ — ลำดับกฎ
              </b>
              <br />
              <b>1. ห้ามมีหน้าที่ว่าง</b> — ถ้ายังมีคนมาทำงาน ทุกหน้าที่ต้องมีคนทำ
              (สำคัญกว่ากฎผูกขาด)
              <br />
              <b>2. ผูกขาดคนทำ</b> — ตราบใดที่ยังมีคนอื่นเหลือ คนทำ ONLINE/บัญชี
              จะไม่ถูกจัดหน้าที่อื่น
              <br />
              <b>3. ถ้าต้องทำซ้อน กระจายให้คนที่ถือน้อยสุดก่อน</b> — ไม่เทงานไปกองที่คนเดียว
              <br />
              <span className="text-xs text-txt-soft">
                เช่น เหลือคนมาทำงาน 1 คน แต่มี 5 หน้าที่ → คนนั้นทำทั้ง 5 · เหลือ 2 คน 6
                หน้าที่ → คนละ 3 · ระบบยังเคารพ "ไม่ให้เป็นคนแทน" และวันลาจริงเสมอ
              </span>
            </Box>
          </Section>
          ...
          >
            ...
            <Box bg={COLORS.cream} border={COLORS.border}>
              <b className="text-maroon inline-flex items-center gap-1">
                <IconLightbulb size={13} strokeWidth={2.4} />
                ตัวอย่าง
              </b>
              <br />
              <b>หน้าที่รายสัปดาห์</b> "ทำความสะอาด" — สัปดาห์นี้คือ
              <b> พนักงาน A</b> · วันพุธมี <b>พนักงาน B</b> เข้าทีมใหม่ →{" "}
              <b>พนักงาน A</b> ยังทำต่อจนวันอาทิตย์ · สัปดาห์หน้าค่อยหมุนถัดไปตามลำดับ
              (อาจถึงคิว <b>พนักงาน B</b>)
              <br />
              <b>หน้าที่รายเดือน</b> "ออนไลน์" — มิถุนายนคือ
              <b> พนักงาน C</b> · วันที่ 15 มิถุนายน <b>พนักงาน C</b> ลาป่วย →
              ระบบเลือกคนแทนเฉพาะวันนั้น · กรกฎาคมค่อยหมุนไปคนถัดไป (ไม่ใช่{" "}
              <b>พนักงาน C</b> รอบ 2 ติด)
            </Box>
          </Section>
          ...
          >
            <p>
              หน้าที่ <b>รายเดือน</b> สามารถเปิดตัวเลือก <b>"ให้สิทธิ์กองกลาง"</b> ได้ —
              เพราะคนทำติดงานทั้งเดือน ขายไม่ทันเพื่อนร่วมงาน ·
              จึงได้แบ่งกองทุกรายการแม้ยอดไม่ถึง 80%
            </p>
            <ul>
              <li>
                แต่ถ้า ADMIN ปิดสิทธิ์ไว้ (ปิดเฉพาะรายการ / ปิดกองกลางทั้งหมด){" "}
          ...
          <Box bg={COLORS.goldPale} border={`${COLORS.gold}40`}>
            ...
            <br />
            กดปุ่ม "ปฏิทินหน้าที่" เพื่อดูตารางหมุนเวียนไปจนถึงสิ้นปี — วางแผนเตรียมตัวได้ (พนักงานดู
            "เฉพาะของคุณ" ได้) · ยังเห็น <b>คนแทนล่วงหน้า</b> ด้วยว่าช่วงไหนใครลา
            ใครมาแทน (จากใบลาที่ยื่นไว้) — ลาวันเดียวขึ้นเลขวันเดียว · หลายวันขึ้นเป็นช่วง ·
            มีแท็บ <b>ย้อนหลัง</b> และ <b>จำนวนครั้ง</b> (ใครทำหน้าที่ไหนไปแล้วกี่วัน/กี่ครั้ง) ·
            ในแท็บจำนวนครั้ง <b>กดบรรทัด "แทน …"</b> เพื่อกางดูว่าไปแทนวันไหนบ้าง
          </Box>
        </div>
      )}

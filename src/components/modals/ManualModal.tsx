        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                ...
                <b>บล็อกการยื่นเบิกใหม่</b> (กัน chain หนี้สะสม) · ADMIN กด
                "อนุญาตให้ยื่นเบิกใหม่" ใน "สรุปเงินเดือน" เพื่อปลดเฉพาะการบล็อก
                (ไม่ได้เคลียร์ยอด · auto-carry ยังหักปกติ)
              </li>
              <li>
          ...
          >
            ...
            <ul>
              ...
              <li>
                พนักงานเปิดดูสลิปย้อนหลังได้จาก <b>ปุ่ม "สลิป"</b> มุมขวาบนของ card
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <b>รายละเอียดบางส่วน</b> — tick เลือกเฉพาะรายการที่ต้องการ · ที่
                    tick ออก อาจจะถูก <b>รวมไว้ในบรรทัด</b> "รายรับอื่นๆ" /
                    "รายการหักอื่นๆ" บนสลิป · <b>เงินสุทธิเท่าเดิม</b>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          >
            ...
            <ul>
              ...
              <li>
                ...
                <b className="text-red">ห้ามกรอกมากกว่าจริง</b> — ระบบจะ clamp
                ลงให้อัตโนมัติ
              </li>
              <li>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <Box bg={COLORS.cream} border={COLORS.border}>
              ...
              <br />
              <b>หน้าที่รายเดือน</b> "Online" — มิถุนายนคือ

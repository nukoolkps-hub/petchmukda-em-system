      ...
      {tab === "leave" && (
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <Box bg={COLORS.creamDark} border={`${COLORS.gold}40`}>
              ...
              <p>
                ...
                <b>ที่มีพนักงานลาในวันนั้นอยู่</b> ระบบจะ{" "}
          ...
          >
            ...
            >
              <p>
                ...
                <b>+1 dailyRate</b> เข้าสลิป ในบรรทัด <b>"เงินเสาร์เปิดพิเศษ"</b>
              </p>
              <p className="mt-1.5 text-xs text-txt-soft">
          ...
          >
            ...
            <p className="mt-1.5 text-xs text-txt-soft">
              ใช้กันยื่นลาทับวันคนอื่นเยอะเกินไป + วางแผนวันหยุดของทีมได้
            </p>
          </Section>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <b>แต่ยอดของพนักงานยังนับครบ</b> — ถ้าขายโปรโมชั่นหรือรับซื้อทองแท่งเยอะ{" "}
          ...
          <Box bg={COLORS.goldPale} border={`${COLORS.gold}40`}>
            ...
            <div className="mt-3 pt-2 border-t border-[#C9973A40] text-xs text-txt-soft leading-relaxed inline-flex items-start gap-1">
              <IconLightbulb
                ...
                className="mt-0.5 shrink-0 text-gold"
              />
              <span>ลาไม่เกิน 2 วัน = ไม่กระทบเงิน · ลาเกินจะถูกหักไปแบ่งเพื่อนที่ไม่ลา</span>
            </div>
          </Box>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                สลิปมีรายละเอียดครบ: เงินเดือนพื้นฐาน · ค่าคอม · โบนัส · รายการหัก ·
                เงินสุทธิ
              </li>
              <li>
        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            <p>
              ...
              — เพราะคนทำติดงานทั้งเดือน ขายไม่ทันเพื่อน · จึงได้แบ่งกองทุกรายการแม้ยอดไม่ถึง
              80%
            </p>
            <ul>
              <li>

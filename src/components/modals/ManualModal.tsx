      ...
      <div className="bg-white rounded-t-3xl px-5.5 pt-6 pb-7 w-full max-w-[560px] shadow-[0_-12px_40px_rgba(45,26,14,0.25)] animate-[slideUp_0.3s_cubic-bezier(.22,.68,0,1.1)] max-h-[92vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 mb-4.5">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-txt-soft mt-0.5">ห้างเพชรทองมุกดา · ระบบพนักงาน</div>
          </div>
        </div>
          ...
          <div className="text-sm text-txt-mid leading-[1.8]">
            ...
            <Section title="📅 วันลาแบ่งเป็น 2 ประเภท" color={C.maroon}>
              <Card title="📅 วันธรรมดา (จันทร์-ศุกร์)" color={C.text}>
                <ul>
                  ...
                  <li>ลาเกินโควต้า → <b className="text-red">หักจากเงินเดือน</b></li>
                  <li>หัก = <b>(เงินเดือน ÷ 30) × จำนวนวันที่เกิน</b></li>
                </ul>
              </Card>
              <Card title="🌅 วันอาทิตย์" color={C.text}>
                <ul>
                  <li><b className="text-red">หักทุกครั้ง</b> ไม่อยู่ในโควต้า</li>
            ...
            <Section title="🌟 โบนัสแห่งความขยัน(ไม่หยุด)" color={C.green}>
              ...
              <ul>
                ...
                <li>ลา 2+ วัน → <b className="text-red">ไม่ได้รับโบนัส</b></li>
              </ul>
            </Section>

            <Box bg={C.goldPale} border={C.gold+"40"}>
              <b className="text-maroon">💡 ตัวอย่าง:</b> เงินเดือน ฿18,000 ลาวันธรรมดา 1 + วันอาทิตย์ 1<br/>
              เรท/วัน = 18,000 ÷ 30 = <b>฿600</b><br/>
              <span className="text-green">✓ ได้โบนัสแห่งความขยัน</span> 1 × 600 = <b>฿600</b><br/>
              <span className="text-red">✗ หักวันอาทิตย์</span> 600 × 1.5 = <b>฿900</b>
            </Box>
          </div>
        )}
          ...
          <div className="text-sm text-txt-mid leading-[1.8]">
            ...
            <Section title="⚠ กฎตัดสิทธิ์ Pool" color={C.red}>
              <Card title="🔻 กฎ 80%" color={C.text}>
                <p>คนที่ <b>ชิ้น &lt; 80% ของ Top</b> ในฝั่งนั้น → <b className="text-red">ตัดออกจาก Pool</b> ฝั่งนั้น (N ลดลง → Base และ K เปลี่ยนตาม)</p>
              </Card>
              <Card title="🚫 Admin ปิดสิทธิ์" color={C.text}>
                <ul>
                  ...
                  <li><b>ปิดทั้งคู่</b> — ไม่ได้ Pool ทั้ง 2 ฝั่ง<br/>
                    + ถ้าขาย &lt; 50% ของ Top → <b className="text-red">ไม่ได้เงินเดือนพื้นฐาน</b></li>
                </ul>
              </Card>
            </Section>

            <Box bg={C.goldPale} border={C.gold+"40"}>
              <b className="text-maroon">💡 ตัวอย่าง Pool ขาย 5 คน · 1,064 ชิ้น</b><br/>

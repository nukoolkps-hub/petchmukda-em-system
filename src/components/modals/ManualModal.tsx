        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <b className="text-red">ถ้าเดือนก่อนเงินสุทธิติดลบ</b> → ระบบจะ{" "}
                <b>ยกยอดติดลบเป็นเบิกล่วงหน้าเดือนนี้อัตโนมัติ</b> (หักจากเงินเดือนเดือนนี้) +{" "}
                <b>บล็อกการยื่นเบิกใหม่</b> (กันหนี้สะสมต่อเนื่อง) · ADMIN กด
                "อนุญาตให้ยื่นเบิกใหม่" ใน "สรุปเงินเดือน" เพื่อปลดเฉพาะการบล็อก

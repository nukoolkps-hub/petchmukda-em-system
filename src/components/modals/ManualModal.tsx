        ...
        <div className="text-sm text-txt-mid leading-[1.8] animate-[fadeIn_0.18s_ease-out]">
          ...
          >
            ...
            <Box bg={COLORS.cream} border={COLORS.border}>
              ...
              <br />
              <b>หน้าที่รายสัปดาห์</b> "ทำความสะอาด" — สัปดาห์นี้คือ "อ๋อม" ·
              วันพุธมี "แจน" เข้าทีมใหม่ → "อ๋อม" ยังทำต่อจนวันอาทิตย์ ·
              สัปดาห์หน้าค่อยหมุนถัดไปตามลำดับ (อาจถึงคิว "แจน")
              <br />
              <b>หน้าที่รายเดือน</b> "Online" — มิถุนายนคือ "วาฬ" · วันที่ 15
              มิถุนายน "วาฬ" ลาป่วย → ระบบเลือกคนแทนเฉพาะวันนั้น · กรกฎาคม
              ค่อยหมุนไปคนถัดไป (ไม่ใช่ "วาฬ" รอบ 2 ติด)
            </Box>
          </Section>

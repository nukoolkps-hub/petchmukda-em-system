...
/** สรุปป้าย poolExclusion → text สำหรับ employee ดู */
...
/** Row ในการ์ดอัตราค่าคอม — label ซ้าย · value+suffix ขวา */
function RateRow({
  label,
  value,
  suffix,
...
export default function SalaryView({
  ...
  return (
    <div>
      ...
      {/* ตำแหน่ง + อัตราค่าคอม (live · sync จาก admin ทันที) */}
      {employeeRole && (
            ...
            {employeeRole.poolGroup ? (
              <>
                <RateRow
                  ...
                  value={employeeInfo?.normalSalePieceRate}
                  suffix="฿/ชิ้น"
                />
                <RateRow
                  label="ขายพิเศษ"
                  value={employeeInfo?.specialSalePieceRate}
                  suffix="฿/ชิ้น"
                />
                <RateRow
                  label="รับซื้อ (กองกลาง)"
                  value={employeeInfo?.buyPieceRate}
                  suffix="฿/ชิ้น"
                />
              </>
            ) : (
              <RateRow
                label="ค่าคอมต่อชิ้น"
                value={employeeInfo?.singlePieceRate}
                suffix="฿/ชิ้น"
              />
            )}
            <RateRow
              label="เชิญสมัครบัตร"
              value={employeeInfo?.invitePieceRate}
              suffix="฿/ครั้ง"
            />
            <RateRow
              label="ย้ายข้อมูลบัตร"
              value={employeeInfo?.transferPieceRate}
              suffix="฿/ครั้ง"
            />
            {employeeInfo?.poolExclusion && (

...
export function Section({title,color,children}){
  return (
    <div className="mb-4">
      <div className="text-sm font-bold mb-2 pl-2.5" style={{color, borderLeft:`3px solid ${color}`}}>{title}</div>
...
export function Box({bg,border,children}){
  return (
    <div className="rounded-[10px] px-3.5 py-3 mt-2.5 text-[13px] text-txt-mid leading-[1.7]"

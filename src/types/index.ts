...
export interface Duty {
  ...
  skipSundays?: boolean;
  /** "ผูกขาดคนทำ" — คนที่ทำหน้าที่นี้ในวันนั้น (คนหลัก **หรือคนแทน**) จะไม่ถูก
   *  จัดหน้าที่อื่นเลยในวันเดียวกัน · หน้าที่อื่นที่เคยตกเป็นของเขาจะกระจาย
   *  ไปให้คนอื่นแทน · ใช้กับงานที่ต้องอยู่กับที่ทั้งวัน (เช่น ONLINE, บัญชี)
   *  default = false (พฤติกรรมเดิม — ทำหน้าที่อื่นควบได้)                  */
  exclusive?: boolean;

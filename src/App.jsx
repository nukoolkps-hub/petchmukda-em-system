...
export default function LeaveApp(){
  ...
  // profile state — ใส่ตัวอย่างไว้ให้เห็นหน้า over-quota ทันที
  const [profile, setProfile] = useState({ name:"นภัส สุขใจ", av:"นส", avType:"text", img:null, role:"ฝ่ายบัญชี", bank:"ธนาคารกรุงไทย", bankAcc:"456-7-89012-3" });
